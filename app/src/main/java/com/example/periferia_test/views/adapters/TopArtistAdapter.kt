...
import com.example.periferia_test.util.DiffUtilCallback
import kotlinx.android.synthetic.main.item_artist_view_layout.view.*

class TopArtistAdapter : PagedListAdapter<ArtistData, TopArtistAdapter.MyViewHolder>(DiffUtilCallback()) {
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindPost(artistData: ArtistData) {
            with(artistData) {
